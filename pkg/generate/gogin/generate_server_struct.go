...
// generateServerStruct creates per-domain handler.go files and central server.go.
func generateServerStruct(intDir string, serviceFuncs []ssacparser.ServiceFunc, modulePath string, doc *openapi3.T) error {

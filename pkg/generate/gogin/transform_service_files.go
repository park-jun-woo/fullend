...
// transformServiceFiles transforms service files in both flat and domain subdirectories.
func transformServiceFiles(intDir string, serviceFuncs []ssacparser.ServiceFunc, models, funcs []string, modulePath string, doc *openapi3.T) error {

...
type ServerInterface interface {
	...
	// (GET /execution-logs)
	ListExecutionLogs(w http.ResponseWriter, r *http.Request)
...
func (siw *ServerInterfaceWrapper) ListExecutionLogs(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListExecutionLogs(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/execution-logs", wrapper.ListExecutionLogs)

...
//fullend:gen ssot=service/workflow/activate_workflow.ssac contract=40ba1ae
func (h *Handler) ActivateWorkflow(c *gin.Context) {
	...
	if _, err = authz.Check(authz.CheckRequest{Action: "ActivateWorkflow", Resource: "workflow", UserID: currentUser.ID, Role: currentUser.Role, ResourceID: wf.ID}); err != nil {

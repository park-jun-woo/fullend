...
func (h *Handler) ArchiveWorkflow(c *gin.Context) {
	...
	if _, err = authz.Check(authz.CheckRequest{Action: "ArchiveWorkflow", Resource: "workflow", UserID: currentUser.UserID, Role: currentUser.Role, ResourceID: id}); err != nil {

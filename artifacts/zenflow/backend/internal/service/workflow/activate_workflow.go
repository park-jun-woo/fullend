...
//fullend:gen ssot=service/workflow/activate_workflow.ssac contract=e0b6c99
func (h *Handler) ActivateWorkflow(c *gin.Context) {
	...
	if _, err = billing.CheckCredits(billing.CheckCreditsRequest{OrgID: wf.OrgID}); err != nil {
	...
	err = h.WorkflowModel.WithTx(tx).UpdateStatus("active", wf.ID)
	if err != nil {

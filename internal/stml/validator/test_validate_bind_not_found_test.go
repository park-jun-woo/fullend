...
//ff:what 존재하지 않는 bind field 참조 시 ERROR 검증
package validator
...
func TestValidateBindNotFound(t *testing.T) {
	...
	pages := []parser.PageSpec{{Name: "test-page", FileName: "test-page.html", Fetches: []parser.FetchBlock{{OperationID: "GetReservation", Binds: []parser.FieldBind{{Name: "nonExistent", Tag: "span"}}}}}}
